...
# Function to display the table using C-style For Loop
c_style_table() {
    local number=$1
    local start=$2
    local end=$3
...
# Main Script Workflow for C-Style Form
while true; do
    ...
    # Step 3: Display the table using C-style For Loop
    c_style_table "$number" "$start" "$end"
